...
namespace gaa::rinex
{
    ...
    enum IonosphericCorrectionType
    {
        GAL,
        GPSA,
        GPSB,
    ...
    namespace v302
    {
        ...
        Nav_data_section_gps parse_nav_dat_gps(std::istream &in, Nav_hdr_section const &hdr);
    }
}
...
#define GAA_RINEX_int(TARGET)                                                         \
    ...
    {                                                                                 \
        ...
        gaa_assert(ec == std::errc{}, std::format("error parsing `{}` to int", str)); \
        TARGET = val;                                                                 \
    }
...
#define GAA_RINEX_double(TARGET)                                                         \
    ...
    {                                                                                    \
        ...
        auto [ptr, ec] = std::from_chars(str.data(), str.data() + str.length(), val);    \
        gaa_assert(ec == std::errc{}, std::format("error parsing `{}` to double", str)); \
        TARGET = val;                                                                    \
    }
