/*
converter between std::tuple and Eigen::Vector
*/
...
decltype(auto) make_tuple(Eigen::MatrixBase<Xpr_1> const &m_1)
  requires(Xpr_1::RowsAtCompileTime != Eigen::Dynamic &&
           Xpr_1::ColsAtCompileTime != Eigen::Dynamic &&
           (Xpr_1::RowsAtCompileTime == 1 || Xpr_1::ColsAtCompileTime == 1))
{
  constexpr auto Size = Xpr_1::RowsAtCompileTime == 1
                            ? Xpr_1::ColsAtCompileTime
                            : Xpr_1::RowsAtCompileTime;
