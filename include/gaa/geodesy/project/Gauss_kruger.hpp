...
namespace gaa
{
    ...
    struct _gauss_kruger_project_send_package_t
    {
        ...
        _gauss_kruger_project_send_package_t(Gauss_kruger_project_coordinate const &gkc)
    ...
    public:
        ...
        Gauss_kruger_project(double val)
            : Gauss_kruger_project(val, -1)
        {
        }
        Gauss_kruger_project(double val, int band);
        Gauss_kruger_project(Identifier id, int band)
            : m_band(band), m_id(id)
        {
        }
        ...
        Gauss_kruger_project_coordinate coordinate(double x, double y, int b, Ellipsoid const &e) const;
    ...
    struct Gauss_kruger_project_coordinate
    {
        ...
        double x, y;
        Gauss_kruger_project project; // its band will be modified ti keep same as this->band
        Ellipsoid const &ellipsoid;

        ~Gauss_kruger_project_coordinate() = default;

        Gauss_kruger_project_coordinate(double xp, double yp, int b, Gauss_kruger_project const &p, Ellipsoid const &e)
    ...
    GAA_channel_acknowledge(s [[maybe_unused]], a [[maybe_unused]])
    {
        return true;
    }
    ...
    GAA_channel_acknowledge(s, a)
    {
        return s.project.interval() == a.interval();
    }
    GAA_channel_eval((Gauss_kruger_project_coordinate), s, a)
    {
    ...
    template <>
    struct Geodetic_coordinate_caster<Gauss_kruger_project_coordinate>
    {
        ...
        static Geodetic_coordinate cast_to(Gauss_kruger_project_coordinate const &pc, Ellipsoid const &e)
        {
            return pc >> e;
        }
    };
    ...
    extern Gauss_kruger const gauss_kruger;
}