...
{
    {
        ...
        double
            ...
            ds = S - ri.s;
        gaa_assert(gaa::within_abs(da, 0, 10));
        gaa_assert(gaa::within_abs(ds, 0, 1));
    }

    {
        ...
        gaa_assert(gaa::within_abs(dl, 0, 1e-3));
        gaa_assert(gaa::within_abs(db, 0, 1e-1));
        gaa_assert(gaa::within_abs(da, 0, 1e-3));
    }
}